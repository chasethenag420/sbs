		...
		<div class="row wrapper">
			...
			<form name='f' action="j_spring_security_check" method='POST'
				...
				<label class="col-sm-4"> <spring:message
						code="label.form.loginEmail"></spring:message>
				</label> <span class="col-sm-8"> <input class="form-control"
					type='text' name='j_username' value=''>
				</span> <br> <br> <label class="col-sm-4"> <spring:message
						code="label.form.loginPass">
					</spring:message></label> <span class="col-sm-8"> <input class="form-control"
			...
			<a class="btn btn-default" href="<c:url value="/signup.html" />"><spring:message
