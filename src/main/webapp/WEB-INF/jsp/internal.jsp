...
<body>
	...
	<div class="internaluserdetails">
		
		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
			<table width="400px" height="150px">
			<tr>
		<td><a href="notifications.jsp" id="notifications">Notification</a>
		</td>
		</tr>
		<tr>
		...
		<tr>
		<td>
		<a href="notifications.jsp" id="notifications">Searchusers</a>
		</td>
		</tr>
		<tr>
